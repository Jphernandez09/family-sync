  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-brand-50 to-white flex flex-col items-center justify-center px-5 py-12">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold text-slate-800">Family Sync</h1>
        <p className="text-slate-500 mt-2 text-sm">Upload the chaos. Get one clean plan.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {mode === "signup" && (
            <Input
              ...
              placeholder="e.g. Sarah Hernandez"
              required
            />
          )}
          <Input
      ...
      <p className="text-xs text-slate-400 mt-6 text-center max-w-xs">
        Family Sync keeps your family's schedule private. We never share your data.{" "}
